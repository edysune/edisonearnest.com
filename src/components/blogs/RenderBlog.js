...
const RenderBlog = ({ //eslint-disable-line
  ...
  // function createInstructionsData(blogMatch) {
  //   let cookingInstructions = [];
  //   let index = 0;
  //   cookingInstructions = blogMatch.instructions.map(instruction => {
  //     index = index + 1;
  ...
  <Container>
    ...
    {/* <SingleColumn>
      <Stack 
        ...
        spacing={4}
      >
        {blogMatch?.overviewInfo.map((info) => (
      ...
      <HeadingInfoContainerLeft>
        ...
        <Stack 
          ...
          spacing={4}
        >
          {blogMatch?.ingredients.map((ingredient) => (
