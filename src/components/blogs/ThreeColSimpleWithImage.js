...
const Link = tw.a`inline-block mt-2 text-sm text-[#013a6a] font-bold cursor-pointer transition duration-300 border-b-2 border-transparent hover:border-[#013a6a]`;
