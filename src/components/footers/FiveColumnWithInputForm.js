...
// const Input = tw.input`bg-gray-300 px-6 py-3 rounded sm:rounded-r-none border-2 sm:border-r-0 border-gray-400 hover:border-[#013a6a] focus:outline-none transition duration-300 w-full`;
