...
const CustomerName = tw.h5`font-semibold text-xl lg:text-2xl xl:text-3xl text-[#013a6a]`;
const CustomerTitle = tw.p`font-medium text-secondary-100`;

const QuotesLeft = tw(QuotesLeftIcon)`w-6 h-6 opacity-75 text-[#013a6a] inline-block mr-1 -mt-3`;
const QuotesRight = tw(QuotesRightIcon)`w-6 h-6 opacity-75 text-[#013a6a] inline-block ml-1 -mt-3`;
