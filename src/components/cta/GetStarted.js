...
const PrimaryBackgroundContainer = tw.div`py-20 lg:py-24 bg-[#013a6a] rounded-lg relative`
...
const SecondaryLink = tw(Link)`text-gray-100 border-gray-500 hover:bg-gray-100 hover:text-[#013a6a] hover:border-[#013a6a]`;
