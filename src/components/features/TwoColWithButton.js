...
export default ({ //eslint-disable-line
  ...
  function RenderButton(props) {
    if (!props.text || props.text === "" || !primaryButtonUrl || primaryButtonUrl === "") { return null; }
    return (
  ...
  function RenderSubHeader(props) {
    ...
    <Container>
      <TwoColumn>
        ...
        <TextColumn textOnLeft={textOnLeft}>
          <TextContent>
            <RenderSubHeader text={subheading}></RenderSubHeader>
            <Heading>{heading}</Heading>
            <Description>{description}</Description>
            <RenderButton text={primaryButtonText}></RenderButton>
          </TextContent>
        </TextColumn>
      </TwoColumn>
    </Container>
