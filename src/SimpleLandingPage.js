  ...
  return (
    <AnimationRevealPage>
      ...
      <HeroRow>
        <UpdateNotice>
          <UpdateNoticeIcon />
            Last Updated 02/23/2024 - Welcome to my site and Pardon My Dust! Currently working on writing a few blog entries, as well as changing how recipes are rendered. Main front page will be updated last.
        </UpdateNotice>
      </HeroRow>
